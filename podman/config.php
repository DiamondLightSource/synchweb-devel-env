<?php
    ...
    $cas_url = 'cas.example.org';

    # Follow CAS SSO
    $cas_sso = false;

    # CAS CA Cert (for SSO)
    $cacert = '/etc/certs/cas.example.org.crt';
    ...
    $auto = array('192.168.33.1');
    $auto_bls = array('i03');
    $auto_exp_hazard = "Some message";
    $auto_sample_hazard = "Some message";
    $auto_user = "dls_mxautocollect";
    $auto_pass = "password";
    ...
    # - Internal maps a beamline to an api "group", there are currently:
    #     em, mx, xpdf
    $bl_types = array(
        array('name' => 'i02', 'group' => 'mx', 'archived' => true),
        array('name' => 'i03', 'group' => 'mx'),
        array('name' => 'i04', 'group' => 'mx'),
        array('name' => 'i11', 'group' => 'xpdf')
    );
